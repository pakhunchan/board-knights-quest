...
The game scaffolds learning across four levels (E1–E4). The lesson design is based on the *Completing Equivalent Fractions* lesson (pages 298–300) from *Direct Instruction Mathematics* (5th Edition) by Stein, Kinder, Rolf, and Silbert.
