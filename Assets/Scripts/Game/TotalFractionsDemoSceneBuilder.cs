...
{
    /// <summary>
    /// Editor utility that builds the Total Fractions Demo scene.
    /// Menu: Board of Education > Build Total Fractions Demo Scene
    /// </summary>
    public static class TotalFractionsDemoSceneBuilder
    {
        [MenuItem("Knight's Quest: Math Adventures/Build Total Fractions Demo Scene")]
        public static void BuildTotalFractionsDemoScene()
        {
            ...
            var manager = gameCoreGo.AddComponent<TotalFractionsDemoManager>();
            ...
            // ── ContentArea (shared by both phases) ──
            ...
            // ── Save Scene ──
            string scenePath = "Assets/Scenes/TotalFractionsDemo.unity";
            if (!AssetDatabase.IsValidFolder("Assets/Scenes"))
                AssetDatabase.CreateFolder("Assets", "Scenes");

            UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, scenePath);
            Debug.Log($"[TotalFractionsDemoSceneBuilder] Total Fractions Demo scene built and saved to {scenePath}");
        }
        ...
        private static void SetRef(SerializedObject so, string fieldName, Object value)
        {
            ...
            if (prop != null)
                ...
                Debug.LogWarning($"[TotalFractionsDemoSceneBuilder] Could not find field '{fieldName}' on {so.targetObject.GetType().Name}");
        }
