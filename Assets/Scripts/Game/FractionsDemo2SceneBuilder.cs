...
{
    /// <summary>
    /// Editor utility that builds the Fractions Demo 2 (Equivalent Fractions) scene.
    /// Menu: Board of Education > Build Fractions Demo 2 Scene
    /// </summary>
    public static class FractionsDemo2SceneBuilder
    {
        [MenuItem("Knight's Quest: Math Adventures/Build Fractions Demo 2 Scene")]
        public static void BuildFractionsDemo2Scene()
        {
            ...
            var manager = gameCoreGo.AddComponent<FractionsDemo2Manager>();
            ...
            // ── Title ──
            var titleGo = CreateText(canvasGo.transform, "Title", "EQUIVALENT FRACTIONS",
            ...
            contentAreaRect.anchorMin = new Vector2(0.1f, 0.25f);
            contentAreaRect.anchorMax = new Vector2(0.9f, 0.8f);
            ...
            // ── Save Scene ──
            string scenePath = "Assets/Scenes/FractionsDemo2.unity";
            if (!AssetDatabase.IsValidFolder("Assets/Scenes"))
                AssetDatabase.CreateFolder("Assets", "Scenes");

            UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, scenePath);
            Debug.Log($"[FractionsDemo2SceneBuilder] Equivalent Fractions scene built and saved to {scenePath}");
        }
        ...
        private static void SetRef(SerializedObject so, string fieldName, Object value)
        {
            ...
            if (prop != null)
                ...
                Debug.LogWarning($"[FractionsDemo2SceneBuilder] Could not find field '{fieldName}' on {so.targetObject.GetType().Name}");
        }
