...
{
    /// <summary>
    /// Editor utility that builds the Total Fractions 2 scene.
    /// Menu: Board of Education > Build Total Fractions 2 Scene
    /// </summary>
    public static class TotalFractions2SceneBuilder
    {
        [MenuItem("Knight's Quest: Math Adventures/Build Total Fractions 2 Scene")]
        public static void BuildTotalFractions2Scene()
        {
            ...
            var manager = gameCoreGo.AddComponent<TotalFractions2Manager>();
            ...
            // ── Save Scene ──
            string scenePath = "Assets/Scenes/TotalFractions2.unity";
            if (!AssetDatabase.IsValidFolder("Assets/Scenes"))
                AssetDatabase.CreateFolder("Assets", "Scenes");

            UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, scenePath);
            Debug.Log($"[TotalFractions2SceneBuilder] Total Fractions 2 scene built and saved to {scenePath}");
        }
        ...
        private static void SetRef(SerializedObject so, string fieldName, Object value)
        {
            ...
            if (prop != null)
                ...
                Debug.LogWarning($"[TotalFractions2SceneBuilder] Could not find field '{fieldName}' on {so.targetObject.GetType().Name}");
        }
