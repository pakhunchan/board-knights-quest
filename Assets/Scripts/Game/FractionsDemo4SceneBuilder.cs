...
{
    /// <summary>
    /// Editor utility that builds the Fractions Demo 4 (simple interactive) scene.
    /// Menu: Board of Education > Build Fractions Demo 4 Scene
    /// </summary>
    public static class FractionsDemo4SceneBuilder
    {
        [MenuItem("Knight's Quest: Math Adventures/Build Fractions Demo 4 Scene")]
        public static void BuildFractionsDemo4Scene()
        {
            ...
            var manager = gameCoreGo.AddComponent<FractionsDemo4Manager>();
            ...
            // ── Save Scene ──
            string scenePath = "Assets/Scenes/FractionsDemo4.unity";
            if (!AssetDatabase.IsValidFolder("Assets/Scenes"))
                AssetDatabase.CreateFolder("Assets", "Scenes");

            UnityEditor.SceneManagement.EditorSceneManager.SaveScene(scene, scenePath);
            Debug.Log($"[FractionsDemo4SceneBuilder] Fractions Demo 4 scene built and saved to {scenePath}");
        }
        ...
        private static void SetRef(SerializedObject so, string fieldName, Object value)
        {
            ...
            if (prop != null)
                ...
                Debug.LogWarning($"[FractionsDemo4SceneBuilder] Could not find field '{fieldName}' on {so.targetObject.GetType().Name}");
        }
